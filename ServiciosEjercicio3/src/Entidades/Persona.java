...
Si desea añadir algún otro atributo, puede hacerlo. Agregar constructores, 
getters y setters.
...
Por último, guardaremos los resultados de los métodos calcularIMC y es 
MayorDeEdad en distintas variables(arrays), para después calcular un porcentaje
...
son mayores de edad y cuantos menores. Para esto, podemos crear unos métodos 
adicionales.
...
public class Persona {
    ...
    public String toString() {
        return "Persona{" + "nombre=" + nombre + ", sexo=" + sexo + ", edad=" + edad + ", peso=" + peso + ", altura=" + altura + ", SetEdad=" + SetEdad + '}';
    }
