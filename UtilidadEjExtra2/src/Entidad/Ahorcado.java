...
public class Ahorcado {
    ...
    private int letrasencontradas, cantidadjugadas;

    public Ahorcado() {
    }

    public Ahorcado(String[] palabrasecreta, int letrasencontradas, int cantidadjugadas) {
    ...
    public void setPalabrasecreta(int i, char charAt) {
        this.palabrasecreta = palabrasecreta;
    }
